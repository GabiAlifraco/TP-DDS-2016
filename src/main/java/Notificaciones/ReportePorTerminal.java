	...
	public void actualizar(Resultado resultado,Terminal terminal) {
	      ...
	      if(busquedaPorTerminal.containsKey(resultado.getTerminal().getNombreTerminal())){
			this.busquedaPorTerminal.replace(resultado.getTerminal().getNombreTerminal(),
					busquedaPorTerminal.get(resultado.getTerminal().getNombreTerminal()) + cantidadTotalBusquedas(resultado,terminal));
		} else {
			busquedaPorTerminal.put(resultado.getTerminal().getNombreTerminal(),cantidadTotalBusquedas(resultado,terminal));
